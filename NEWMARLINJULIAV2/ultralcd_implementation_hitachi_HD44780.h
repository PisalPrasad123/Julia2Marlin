...
*/    
#endif//LCD_HEIGHT > 2
#endif                                              //julia edit, i put this here
...
# endif//LCD_WIDTH > 19
  ...
  lcd.setCursor(0, LCD_HEIGHT - 2);         //julia edit to make status and bar show together
